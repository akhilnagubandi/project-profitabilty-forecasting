                    ...
                    <form name = "proform" method = "post" action = "">
                        <table>
                            <tr>
                                ...
                                <td class = "main"><input type = "text" name = "fname" id = "fname"></td>
                            </tr>
                            <tr>
                                <td class = "main">Last Name</td>
                                <td class = "main"><input type = "text" name = "lname" id = "lname"></td>
                            </tr>
                            <tr>
                                <td class = "main">Band</td>
                                <td class = "main"><select name = "band[]" id = "">
                            ...
                            <tr>
                                <td class = "main">Mobile Number</td>
                                <td class = "main"><select name="countryCode[]" id="">
                                        <option data-countryCode="" value="" selected disabled>---Select Country Code---</option>
                                    ...
                                    &thinsp;<input type = "text" name = "mnum" id = "mnum"></td>
                            </tr>
                            <tr>
                                <td class = "main">Extension</td>
                                <td class = "main"><input type = "text" name = "ext" id = "ext"></td>
                            </tr>
                            <tr>
                                <td class = "main">Email</td>
                                <td class = "main"><output name = "email" id = "email"><?php echo $_SESSION['user']; ?></output>@TechMahindra.com</td>
                            </tr>
                            <tr>
                                <td class = "main"></td>
                                <td class = "main"><button class = "btnSubmit" type = "submit" name = "submit">Request for edits</button>
                                    <style type = "text/css">
                                    .btnSubmit{
                                        color: #FF0000;
                                        background: #D5D5D5;
...
<?php
    if(isset($_POST["submit"]))
    {
        $fname = $_POST['fname'];
        $lname = $_POST['lname'];
        foreach($_REQUEST['band'] as $band);
        foreach($_REQUEST['countryCode'] as $telecode);
        $mnum = $_POST['mnum'];
        $ext = $_POST['ext'];
                
        $updateque = mysql_query("insert into profilerequest(EmployeeID,FullName,LastName,Band,Code,Mobile,Extension) values('".$_SESSION['user']."','$fname','$lname','$band','$telecode','$mnum','$ext')");
