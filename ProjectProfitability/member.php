            ...
            <center>
                ...
                <fieldset>
                    <table>
                        <tr>
                                ...
                                <td><label>&thinsp;Band: </label><select name = "empband" id = "empband">
                                    <option value ="">Any</option>
                                    ...
                                    if($_POST["empband"]!="")
                                    {
                                        ...
                                        $con.="Band = '".$_POST['empband']."'";
                                    }
                                    ?>
                                    </select>
                                </td>
                               <td><label>&thinsp;Location: </label><select name = "emplocation" id = "emplocation" >
                                    <option value ="">Any</option>
                                    <option value = "ONSITE"> Onsite</option>
                                    <option value = "OFFSHORE"> Offshore</option>
                                    <?php
                                    if($_POST["emplocation"]!="")
                                    {
                                        if($_POST["empband"]!="" || $_POST["emprole"]!="")
                                        {
                                               $con.=" and ";
                                        }
                                        $con.="Location = '".$_POST['emplocation']."'";
                                    }
                                     if($_POST['emprole']!="" || $_POST['empband']!="" || $_POST['emplocation']!="")
                                    { $cond=" where ".$con;}
                                    ?>
                                    </select>
                               </td>
                ...
                <fieldset>
                    <?php
                       ...
                       if(isset($_POST["submit"]) &&  ($_POST['emprole']!="" || $_POST['empband']!="" || $_POST['emplocation']!=""))
                       {
                            $tab = mysql_query("select FName,LName,username,Role,band,Location from loginaccess ".$cond." order by Role ASC;");
                           echo "<div>Showing ".$con."<br></div>";
                             
                       }
                    else
                    {
                         $tab = mysql_query("select FName,LName,username,Role,band,Location from loginaccess order by Role ASC;");
