...
//                   insert the entered details into projectdetails table
                    if($flag == 0)
                    {
                        $insertdetails="INSERT INTO projectdetails(ProjectID,Name,StartDate,EndDate,IBGHead,IBUHead,ProgramManager,ProjectManager,NoOfMonths,NoOfYears,Type,Revenue,currency) VALUES('$projectid','$pname','$sdate','$edate','$ibgname','$ibuname','$pgmname','$pmname','$months','$noofyears','$pro','$revenue','$curr');";
            ...
            <form name = "form1" method="post" onsubmit = "det();" autocomplete="off">
                <fieldset>
                    ...
                    <table>
                        <tr>
                            <td>IBG Head</td>
                            <td><input type = "text" name = "ibghead" size = "16"></td>
                            <td>&emsp;&emsp;</td>
                            <td>IBU Head</td>
                            <td><input type = "text" name = "ibuhead" size = "16"></td>
                            <td>&emsp;&emsp;</td>
                        </tr>
                        <tr>
                            <td>Program Manager</td>
                            <td><input type = "text" name = "pgmanager" size = "16"></td>
                            <td>&emsp;&emsp;</td>
                            <td>Project Manager</td>
                            <td><input type = "text" name = "pmanager" size = "16"></td>
                            <td>&emsp;&emsp;</td>
                        </tr>
                    </table>
                    <br><br>
